                            ...
                            <div class="row">
                                <div class="col col-12 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $users->name) }}" required>
                                    </div>
                                </div>
                                <div class="col col-12 col-lg-3">
                                    <div class="form-group">
                                        <label for="identity_card_number">NIK</label>
                                        <input type="number" class="form-control" name="identity_card_number" id="identity_card_number" value="{{ $users->identity_card_number }}">
                                    </div>
                                </div>
                                <div class="col col-12 col-lg-3">
                                    <div class="form-group">
                                        <label for="phone">No. HP</label>
                                        <input type="number" class="form-control" name="phone" id="phone" value="{{ $users->phone }}">
                                    </div>
                                </div>
                                <div class="col col-12 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" name="gender" id="gender" value="1" @if ($users->gender == '1') checked @endif> Pria
                                        <input type="radio" name="gender" id="gender" value="0" @if ($users->gender == '0') checked @endif> Wanita
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="province_id" id="province_id">
                                            ...
                                            <option value="{{ $province->code }}" @if ($province->code == $users->province_id) selected @endif>
                                                {{ $province->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="city_id" id="city_id" class="form-control">
                                            ...
                                            <option value="{{ $city->code }}" @if ($city->code == $users->city_id) selected @endif>
                                                {{ $city->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="district_id" id="district_id" class="form-control">
                                            ...
                                            <option value="{{ $district->code }}" @if ($district->code == $users->district_id) selected @endif>
                                                {{ $district->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col col-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="village_id" id="village_id" class="form-control">
                                            ...
                                            <option value="{{ $village->code }}" @if ($village->code == $users->village_id) selected @endif>
                                                {{ $village->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col col-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="rt" id="rt" value="{{ $users->rt }}">
                                    </div>
                                </div>
                                <div class="col col-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="rw">RW</label>
                                        <input type="number" class="form-control" name="rw" id="rw" value="{{ $users->rw }}">
                                    </div>
                                </div>
                                <div class="col col-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="postcode">Kode Pos</label>
                                        <input type="number" class="form-control" name="postcode" id="postcode" value="{{ $users->postcode }}" placeholder="isikan angka saja">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <img src="{{ Storage::url('images/users/' . $users->profile_image) }}" alt="Profile Image" class="img-fluid">
                                        </p>
                                        @else
                                        <p>Belum ada foto</p>
                                        @endif
